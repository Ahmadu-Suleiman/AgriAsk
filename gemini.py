...
def get_response(prompt, number):
    try:
        ...
        if len(history) == 0:
            ...
            knowledge. You are to recognize and respond in the same language the questions are asked (English, Hausa, 
            ...
            than 400 character count. Here is their question, "{prompt}".''')
